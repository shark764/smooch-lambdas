    ...
    describe('#create', () => {
        ...
        it('should call http', () => {
            ...
            return api.create(serviceAccountId, keyName).then(() => {
                const url = `${serviceUrl}/v1.1/serviceaccounts/${serviceAccountId}/keys`;
    ...
    describe('#get', () => {
        it('should call http', () => {
            return api.get(serviceAccountId, keyId).then(() => {
                const url = `${serviceUrl}/v1.1/serviceaccounts/${serviceAccountId}/keys/${keyId}`;
                httpSpy.should.have.been.calledWith('GET', url, undefined, buildTestHeaders(authHeaders));
            });
        });
    ...
    describe('#getJwt', () => {
        it('should call http', () => {
            return api.getJwt(serviceAccountId, keyId).then(() => {
                const url = `${serviceUrl}/v1.1/serviceaccounts/${serviceAccountId}/keys/${keyId}/jwt`;
                httpSpy.should.have.been.calledWith('GET', url, undefined, buildTestHeaders(authHeaders));
            });
        });
