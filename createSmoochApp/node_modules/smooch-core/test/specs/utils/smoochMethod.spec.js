...
describe('Smooch Method', () => {
    ...
    describe('method requires appId', () => {
        beforeEach(() => {
            ...
            expected = {
                url: `${serviceUrl}/v1.1/apps/${appId}/param1/${param1}`,
                param1,
            };
        });
    ...
    describe('appId resolved by credential scope', () => {
        beforeEach(() => {
            ...
            expected = {
                url: `${serviceUrl}/v1.1/param1/${param1}`,
                param1,
            };
        });
    ...
    describe('many params', () => {
        ...
        beforeEach(() => {
            ...
            expected = {
                url: `${serviceUrl}/v1.1/param1/${param1}/param2/${param2}/param3/${param3}`,
                param1,
                param2,
                param3,
            };
    ...
    describe('simple methods', () => {
        ...
        beforeEach(() => {
            ...
            expectedUrl = `${serviceUrl}/v1.1/param1/${param1}`;
            body = {
                foo: 'bar',
            };
        });
        ...
        it('should make a GET', () => {
            return testApi.getMethod(param1).then(() => {
                httpSpy.should.have.been.calledWith('GET', expectedUrl, undefined, buildTestHeaders(authHeaders));
            });
        });

        it('should make a POST', () => {
            return testApi.postMethod(param1, body).then(() => {
                httpSpy.should.have.been.calledWith('POST', expectedUrl, body, buildTestHeaders(authHeaders));
            });
        });

        it('should make a PUT', () => {
            return testApi.putMethod(param1, body).then(() => {
                httpSpy.should.have.been.calledWith('PUT', expectedUrl, body, buildTestHeaders(authHeaders));
            });
        });

        it('should make a DELETE', () => {
            return testApi.deleteMethod(param1).then(() => {
                httpSpy.should.have.been.calledWith('DELETE', expectedUrl, undefined, buildTestHeaders(authHeaders));
            });
        });
    });
});
