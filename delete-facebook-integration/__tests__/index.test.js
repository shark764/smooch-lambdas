...
describe('delete-facebook-integration', () => {
  describe('Everthing is successful', () => {
    it('sends back status 200 when the facebook integration is deleted successfully', async () => {
  ...
  it('sends back status 500 when there is a error deleting facebook integration', async () => {
