    ...
    body: JSON.stringify({
      ...
      parameters: {
        ...
        message: {
          ...
          text: 'abc',
          actions: [
            { type: 'reply', text: 'reply text 1', payload: 'reply payload 1' },
            { type: 'reply', text: 'reply text 2', payload: 'reply payload 2' },
          ],
        },
      },
    }),
        ...
        Records: [{
          body: JSON.stringify({
            ...
            parameters: {
              ...
              message: {
                type: 'image',
                mediaUrl: 'https://www.xyz.com/image.jpg',
                altText: 'alttext',
                text: 'text',
              },
            },
        ...
        Records: [{
          body: JSON.stringify({
            ...
            parameters: {
              ...
              message: {
                type: 'location',
                coordinates: { lat: 1232, long: 3454 },
                location: { address: 'defwe', name: 'aefef' },
              },
            },
          }),
        }],
                ...
                items: [
                  {
                    ...
                    mediaUrl: 'mediaurl',
                    actions: [
                      { text: 'Select', type: 'postback', payload: 'payload' },
                      { text: 'More info', type: 'link', uri: 'uri' },
                    ],
                  },
                  {
                    title: 'title2',
                    ...
                    mediaUrl: 'mediaurl2',
                    actions: [
                      { text: 'Select2', type: 'postback', payload: 'payload2' },
                      { text: 'More info2', type: 'link', uri: 'uri2' },
                    ],
                  },
                ],
              },
